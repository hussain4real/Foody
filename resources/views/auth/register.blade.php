<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="building_number" class="block mt-1 w-full" type="text" name="building_number" :value="old('building_number')" required autofocus autocomplete="building_number" />
        ...
        <div>
            ...
            <x-text-input id="zone" class="block mt-1 w-full" type="text" name="zone" :value="old('zone')" required autofocus autocomplete="zone" />
